...
echo [96mUsage: upload_arm_cortex_m33f.cmd [spi^|i2c]
...
echo   e.g. to use spi as the host communication interface: upload_arm_cortex_m33f.cmd spi (default: spi)
echo   e.g. to use i2c as the host communication interface: upload_arm_cortex_m33f.cmd i2c[0m
