...
echo [96mUsage: build_arm_cortex_m0plus.cmd [spi^|i2c]
...
echo   e.g. to use spi as the host communication interface: build_arm_cortex_m0plus.cmd spi (default: spi)
echo   e.g. to use i2c as the host communication interface: build_arm_cortex_m0plus.cmd i2c[0m
