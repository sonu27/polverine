...
echo [96mUsage: upload_arm_cortex_m0plus.cmd [spi^|i2c]
...
echo   e.g. to use spi as the host communication interface: upload_arm_cortex_m0plus.cmd spi (default: spi)
echo   e.g. to use i2c as the host communication interface: upload_arm_cortex_m0plus.cmd i2c[0m
...
pio run --environment %buildType%_%hostCommunicationInterface% --target upload
