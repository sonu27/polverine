 ...
 * Bosch Sensortec.
 *
 * @file combridge_defs.h
 *
 * @brief Serial communication interface definitions
 *
 *
 */

#ifndef COMBRIDGE_DEFS_H
#define COMBRIDGE_DEFS_H
...
/*! Combridge major version (semantic-versioning) */
#define COMBRIDGE_MAJOR_VERSION 7
/*! Combridge minor version (semantic-versioning) */
#define COMBRIDGE_MINOR_VERSION 3
/*! Combridge patch version (semantic-versioning) */
#define COMBRIDGE_PATCH_VERSION 0

/** Combridge version as a string */
#define COMBRIDGE_VERSION      "7.3.0"
...
/*!
* @brief Unique handle for a combridge serial communication interface.
*/
typedef void* combridge_handle_t;

#endif /* COMBRIDGE_DEFS_H */
