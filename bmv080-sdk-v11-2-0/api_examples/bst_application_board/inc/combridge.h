 ...
 * @file combridge.h
 *
 * @brief Header for the serial communication interface functions in bmv080_common.c.
 */
...
/******************************************************************************/
#define BMV080_I2C_INTF (0)
#define BMV080_SPI_INTF (1)

/*! 0: No warning or error */
#define E_COMBRIDGE_OK                          ((int8_t)0)
/*! -1: Unable to claim interface */
#define E_COMBRIDGE_ERROR_UNABLE_CLAIM_INTF     ((int8_t)-1)
/*! -2: Invalid COINES API version */
#define E_COMBRIDGE_ERROR_INVALID_API_VERSION   ((int8_t)-2)
/*! -3: Unable to Open Device */
#define E_COMBRIDGE_UNABLE_OPEN_DEVICE          ((int8_t)-3)
/*! -4: Unknown host interface */
#define E_COMBRIDGE_ERROR_UNKNOWN_HOST_INTF     ((int8_t)-4)
/*! -5: Combridge initialization failed */
#define E_COMBRIDGE_ERROR_INIT_FAILED           ((int8_t)-5)
